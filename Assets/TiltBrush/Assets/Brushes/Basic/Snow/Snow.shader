	...
	SubShader {
		Pass {
			...
			v2f vert (ParticleVertexWithSpread_t v)
			{
				...
				float4 worldPos = OrientParticleAndSpread_WS(
				...
				worldPos = musicReactiveAnimationWorldSpace(worldPos, v.color, _BeatOutput.w, worldPos.y*5);
#else
				o.color = v.color;
#endif
