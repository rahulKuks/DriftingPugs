...
namespace Lofinator
{
	...
	int InternalRegisterEffectDefinition(UnityAudioEffectDefinition& definition)
	{
		...
		RegisterParameter(definition, "Decimation", "Hz", 0.1f, 24000.0f, 24000.0f, 1.0f, 3.0f, P_DECRATE);
		RegisterParameter(definition, "Quantization", "", 1.0f, 24.0f, 8.0f, 1.0f, 1.0f, P_QUANT);
		return numparams;
	}
